...
public class LoginSampleHelper {
    ...
    public static  String APP_KEY = "23462223";

    public static final String APP_SECRET = "12f9ee5d55d59b4e5551457c0ee3e729";

    //以下两个内容是测试环境使用，开发无需关注
//    public static final String APP_KEY_TEST = "4272";  //60026702

    public static final String APP_KEY_TEST = APP_KEY;
